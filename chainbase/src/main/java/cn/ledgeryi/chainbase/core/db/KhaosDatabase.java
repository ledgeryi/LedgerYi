...
@Component
public class KhaosDatabase extends LedgerYiDatabase {
  ...
  @Override
  public Object get(byte[] key) throws InvalidProtocolBufferException, ItemNotFoundException, BadItemException {
    return null;
  }
  ...
  public void removeBlk(Sha256Hash hash) {
  ...
  public void setHead(KhaosBlock blk) {
    this.head = blk;
  }
