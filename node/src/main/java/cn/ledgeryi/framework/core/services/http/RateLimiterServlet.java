...
import cn.ledgeryi.framework.core.services.ratelimiter.RateLimiterContainer;
import cn.ledgeryi.framework.core.services.ratelimiter.RuntimeData;
import cn.ledgeryi.framework.core.services.ratelimiter.adapter.DefaultBaseQqsAdapter;
import cn.ledgeryi.framework.core.services.ratelimiter.adapter.GlobalPreemptibleAdapter;
import cn.ledgeryi.framework.core.services.ratelimiter.adapter.IPQPSRateLimiterAdapter;
import cn.ledgeryi.framework.core.services.ratelimiter.adapter.IPreemptibleRateLimiter;
import cn.ledgeryi.framework.core.services.ratelimiter.adapter.IRateLimiter;
import cn.ledgeryi.framework.core.services.ratelimiter.adapter.QpsRateLimiterAdapter;

@Slf4j
public abstract class RateLimiterServlet extends HttpServlet {

  private static final String KEY_PREFIX_HTTP = "http_";
  private static final String ADAPTER_PREFIX = "cn.ledgeryi.core.services.ratelimiter.adapter.";
