  ...
  public static List<Actuator> createActuator(TransactionCapsule transactionCapsule, Manager manager) {
    ...
    try {
      actuatorList.add(getActuatorByContract(contract, manager, transactionCapsule));
        ...
        log.error("createActuator error, ", e);
    }
    return actuatorList;
  }

  private static Actuator getActuatorByContract(Protocol.Transaction.Contract contract, Manager manager, TransactionCapsule tx)
