package cn.ledgeryi.framework.common.entity;
...
public class NodeInfo {
  ...
  public Map<String, String> getCheatMasterInfoMap() {
    return cheatMasterInfoMap;
  }

  public NodeInfo setCheatMasterInfoMap(
      Map<String, String> cheatMasterInfoMap) {
    this.cheatMasterInfoMap = cheatMasterInfoMap;
    return this;
  }
  ...
  public Protocol.NodeInfo transferToProtoEntity() {
    ...
    builder.putAllCheatMasterInfoMap(getCheatMasterInfoMap());
