...
public class PeerServer {
  ...
  public void start(int port) {
    ...
    LedgerYiChannelInitializer ledgerYiChannelInitializer = ctx.getBean(LedgerYiChannelInitializer.class, "");
    try {
      ...
      b.childHandler(ledgerYiChannelInitializer);
      // Start the client.
      ...
      log.info("TCP listener is closed");
    } catch (Exception e) {
