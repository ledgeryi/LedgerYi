...
public class ProgramInvokeMockImpl implements ProgramInvoke {
  ...
  public ProgramInvokeMockImpl() {
    ...
    this.deposit.createContract(contractAddress,
        new ContractCapsule(SmartContractOuterClass.SmartContract.newBuilder().setContractAddress(
  ...
  public DataWord getOriginAddress() {
    ...
    byte[] addr = SignUtils.fromPrivate(cowPrivKey, DBConfig.isECKeyCryptoEngine()).getAddress();
