...
public enum OpCode {
   ...
   */
  STOP(0x00, 0, 0, OpCode.Tier.SpecialTier),
   ...
   */
  ADD(0x01, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x02) Multiplication operation
   */
  MUL(0x02, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x03) Subtraction operations
   */
  SUB(0x03, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x04) Integer division operation
   */
  DIV(0x04, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x05) Signed integer division operation
   */
  SDIV(0x05, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x06) Modulo remainder operation
   */
  MOD(0x06, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x07) Signed modulo remainder operation
   */
  SMOD(0x07, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x08) Addition combined with modulo remainder operation
   */
  ADDMOD(0x08, 3, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x09) Multiplication combined with modulo remainder operation
   */
  MULMOD(0x09, 3, 1, OpCode.Tier.SpecialTier),
  /**
   ...
   */
  SIGNEXTEND(0x0b, 2, 1, OpCode.Tier.SpecialTier),
   ...
   */
  LT(0X10, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x11) Greater-than comparison
   */
  GT(0X11, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x12) Signed less-than comparison
   */
  SLT(0X12, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x13) Signed greater-than comparison
   */
  SGT(0X13, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x14) Equality comparison
   */
  EQ(0X14, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x15) Negation operation
   */
  ISZERO(0x15, 1, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x16) Bitwise AND operation
   */
  AND(0x16, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x17) Bitwise OR operation
   */
  OR(0x17, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x18) Bitwise XOR operation
   */
  XOR(0x18, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x19) Bitwise NOT operationr
   */
  NOT(0x19, 1, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x1a) Retrieve single byte from word
   */
  BYTE(0x1a, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x1b) Shift left
   */
  SHL(0x1b, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x1c) Logical shift right
   */
  SHR(0x1c, 2, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x1d) Arithmetic shift right
   */
  SAR(0x1d, 2, 1, OpCode.Tier.SpecialTier),
   ...
   */
  ADDRESS(0x30, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x31) Get balance of the given account
   */
  BALANCE(0x31, 1, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x32) Get execution origination address
   */
  ORIGIN(0x32, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x33) Get caller address
   */
  CALLER(0x33, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x34) Get deposited value by the instruction/transaction responsible for this execution
   */
  CALLVALUE(0x34, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x35) Get input data of current environment
   */
  CALLDATALOAD(0x35, 1, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x36) Get size of input data in current environment
   */
  CALLDATASIZE(0x36, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x37) Copy input data in current environment to memory
   */
  CALLDATACOPY(0x37, 3, 0, OpCode.Tier.SpecialTier),
  /**
   * (0x38) Get size of code running in current environment
   */
  CODESIZE(0x38, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x39) Copy code running in current environment to memory
   */
  CODECOPY(0x39, 3, 0, OpCode.Tier.SpecialTier), // [len code_start mem_start CODECOPY]

  RETURNDATASIZE(0x3d, 0, 1, OpCode.Tier.SpecialTier),

  RETURNDATACOPY(0x3e, 3, 0, OpCode.Tier.SpecialTier),
  /**
   * (0x3a) Get price of gas in current environment
   */
  GASPRICE(0x3a, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x3b) Get size of code running in current environment with given offset
   */
  EXTCODESIZE(0x3b, 1, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x3c) Copy code running in current environment to memory with given offset
   */
  EXTCODECOPY(0x3c, 4, 0, OpCode.Tier.SpecialTier),
  /**
   * (0x3f) Returns the keccak256 hash of a contract’s code
   */
  EXTCODEHASH(0x3f, 1, 1, OpCode.Tier.SpecialTier),
   ...
   */
  BLOCKHASH(0x40, 1, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x41) Get the block’s coinbase address
   */
  COINBASE(0x41, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (x042) Get the block’s timestamp
   */
  TIMESTAMP(0x42, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x43) Get the block’s number
   */
  NUMBER(0x43, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x44) Get the block’s difficulty
   */
  DIFFICULTY(0x44, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x45) Get the block’s gas limit
   */
  GASLIMIT(0x45, 0, 1, OpCode.Tier.SpecialTier),
   ...
   */
  POP(0x50, 1, 0, OpCode.Tier.SpecialTier),
  /**
   * (0x51) Load word from memory
   */
  MLOAD(0x51, 1, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x52) Save word to memory
   */
  MSTORE(0x52, 2, 0, OpCode.Tier.SpecialTier),
  /**
   * (0x53) Save byte to memory
   */
  MSTORE8(0x53, 2, 0, OpCode.Tier.SpecialTier),
  /**
   ...
   */
  MSIZE(0x59, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x5a) Get the amount of available gas
   */
  GAS(0x5a, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x5b)
   */
   ...
   */
  PUSH1(0x60, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x61) Place 2-byte item on stack
   */
  PUSH2(0x61, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x62) Place 3-byte item on stack
   */
  PUSH3(0x62, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x63) Place 4-byte item on stack
   */
  PUSH4(0x63, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x64) Place 5-byte item on stack
   */
  PUSH5(0x64, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x65) Place 6-byte item on stack
   */
  PUSH6(0x65, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x66) Place 7-byte item on stack
   */
  PUSH7(0x66, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x67) Place 8-byte item on stack
   */
  PUSH8(0x67, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x68) Place 9-byte item on stack
   */
  PUSH9(0x68, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x69) Place 10-byte item on stack
   */
  PUSH10(0x69, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x6a) Place 11-byte item on stack
   */
  PUSH11(0x6a, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x6b) Place 12-byte item on stack
   */
  PUSH12(0x6b, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x6c) Place 13-byte item on stack
   */
  PUSH13(0x6c, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x6d) Place 14-byte item on stack
   */
  PUSH14(0x6d, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x6e) Place 15-byte item on stack
   */
  PUSH15(0x6e, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x6f) Place 16-byte item on stack
   */
  PUSH16(0x6f, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x70) Place 17-byte item on stack
   */
  PUSH17(0x70, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x71) Place 18-byte item on stack
   */
  PUSH18(0x71, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x72) Place 19-byte item on stack
   */
  PUSH19(0x72, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x73) Place 20-byte item on stack
   */
  PUSH20(0x73, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x74) Place 21-byte item on stack
   */
  PUSH21(0x74, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x75) Place 22-byte item on stack
   */
  PUSH22(0x75, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x76) Place 23-byte item on stack
   */
  PUSH23(0x76, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x77) Place 24-byte item on stack
   */
  PUSH24(0x77, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x78) Place 25-byte item on stack
   */
  PUSH25(0x78, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x79) Place 26-byte item on stack
   */
  PUSH26(0x79, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x7a) Place 27-byte item on stack
   */
  PUSH27(0x7a, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x7b) Place 28-byte item on stack
   */
  PUSH28(0x7b, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x7c) Place 29-byte item on stack
   */
  PUSH29(0x7c, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x7d) Place 30-byte item on stack
   */
  PUSH30(0x7d, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x7e) Place 31-byte item on stack
   */
  PUSH31(0x7e, 0, 1, OpCode.Tier.SpecialTier),
  /**
   * (0x7f) Place 32-byte (full word) item on stack
   */
  PUSH32(0x7f, 0, 1, OpCode.Tier.SpecialTier),
   ...
   */
  DUP1(0x80, 1, 2, OpCode.Tier.SpecialTier),
  /**
   * (0x81) Duplicate 2nd item on stack
   */
  DUP2(0x81, 2, 3, OpCode.Tier.SpecialTier),
  /**
   * (0x82) Duplicate 3rd item on stack
   */
  DUP3(0x82, 3, 4, OpCode.Tier.SpecialTier),
  /**
   * (0x83) Duplicate 4th item on stack
   */
  DUP4(0x83, 4, 5, OpCode.Tier.SpecialTier),
  /**
   * (0x84) Duplicate 5th item on stack
   */
  DUP5(0x84, 5, 6, OpCode.Tier.SpecialTier),
  /**
   * (0x85) Duplicate 6th item on stack
   */
  DUP6(0x85, 6, 7, OpCode.Tier.SpecialTier),
  /**
   * (0x86) Duplicate 7th item on stack
   */
  DUP7(0x86, 7, 8, OpCode.Tier.SpecialTier),
  /**
   * (0x87) Duplicate 8th item on stack
   */
  DUP8(0x87, 8, 9, OpCode.Tier.SpecialTier),
  /**
   * (0x88) Duplicate 9th item on stack
   */
  DUP9(0x88, 9, 10, OpCode.Tier.SpecialTier),
  /**
   * (0x89) Duplicate 10th item on stack
   */
  DUP10(0x89, 10, 11, OpCode.Tier.SpecialTier),
  /**
   * (0x8a) Duplicate 11th item on stack
   */
  DUP11(0x8a, 11, 12, OpCode.Tier.SpecialTier),
  /**
   * (0x8b) Duplicate 12th item on stack
   */
  DUP12(0x8b, 12, 13, OpCode.Tier.SpecialTier),
  /**
   * (0x8c) Duplicate 13th item on stack
   */
  DUP13(0x8c, 13, 14, OpCode.Tier.SpecialTier),
  /**
   * (0x8d) Duplicate 14th item on stack
   */
  DUP14(0x8d, 14, 15, OpCode.Tier.SpecialTier),
  /**
   * (0x8e) Duplicate 15th item on stack
   */
  DUP15(0x8e, 15, 16, OpCode.Tier.SpecialTier),
  /**
   * (0x8f) Duplicate 16th item on stack
   */
  DUP16(0x8f, 16, 17, OpCode.Tier.SpecialTier),
  ...
  CREATE(0xf0, 3, 1, OpCode.Tier.SpecialTier),
  /**
   ...
   */
  RETURN(0xf3, 2, 0, OpCode.Tier.SpecialTier),
   ...
   */
  REVERT(0xfd, 2, 0, OpCode.Tier.SpecialTier),
  /**
   * (0xff) Halt execution and register account for later deletion
   */
  SUICIDE(0xff, 1, 0, OpCode.Tier.SpecialTier);
  ...
  OpCode(int op, int require, int ret, Tier tier, CallFlags... callFlags) {
    this.opcode = (byte) op;
